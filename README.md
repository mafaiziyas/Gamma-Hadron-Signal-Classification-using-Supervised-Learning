...
**Key EDA insights:** EDA showed that observations with lower fLength and fSize values are associated with a 99% likelihood of belonging to the gamma class, suggesting that these variables are highly discriminative features for gamma particle detection.
